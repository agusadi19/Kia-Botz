...
const thumb = fs.readFileSync('./media/ganteng.jpg')
const canss = fs.readFileSync('./media/canss.jpg')
...
petik = '```'
fake = '©𝙃𝙄𝙈𝘼𝙍𝙐 𝙊𝙁𝙁𝙄𝘾𝙄𝘼𝙇'//GANTI NAMA KAMU BEP
ban =[]
...
module.exports = dha = async (dha, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = dha.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "𝕾𝖎𝖑𝖆𝖍𝖐𝖆𝖓 𝕻𝖎𝖑𝖎𝖍 𝕯𝖎𝖘𝖓𝖎!","footerText": "𝙃𝙄𝙈𝘼𝙍𝙐 𝘽𝙊𝙏𝙕 🤖","listType": "SINGLE_SELECT","sections": list}}, {})
...
const fhidetag = {key : {fromMe:false, //by Iky
	participant : '0@s.whatsapp.net'},
       message: {
              orderMessage: {
                            ...
                            status: 1,
                            surface : 1,
                            message: `𝙃𝙄𝙈𝘼𝙍𝙐 𝙊𝙁𝙁𝙄𝘾𝙄𝘼𝙇`, 
                            orderTitle: `Hengker Kah Banh?`,
                            thumbnail: thumb, 
     ...
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
       ...
       console.error(err)
        ...
        const ftoko = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./media/sherlynn.jpg`)},"title": `©𝙃𝙄𝙈𝘼𝙍𝙐 𝘽𝙊𝙏𝙕`,"description": " 𝙃𝙄𝙈𝘼𝙍𝙐 𝘽𝙊𝙏𝙕", "currencyCode": "IDR","priceAmount1000": "99999999","retailerId": "𝙃𝙄𝙈𝘼𝙍𝙐 𝘽𝙊𝙏𝙕","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
          ...
          if (susunkata.hasOwnProperty(sender.split('@')[0]) && !isCmd) {
            ...
            if (sambungkata.hasOwnProperty(sender.split('@')[0]) && !isCmd) {
                ...
                if (userAnswer.startsWith(jawaban[jawaban.length - 1])) {
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/sambungkata?apikey=himaru&text=${userAnswer}`)
                    await dha.sendMessage(from, get_result.result, text, { quoted: mek }).then(() => {
            ...
            if (akinator.hasOwnProperty(sender.split('@')[0]) && !isCmd && ["0", "1", "2", "3", "4", "5"].includes(body)) {
                ...
                var ini_url = `https://api.lolhuman.xyz/api/akinator/answer?apikey=himaru&server=${server}&frontaddr=${frontaddr}&session=${session}&signature=${signature}&answer=${budy}&step=${step}`
                ...
                if (get_result.hasOwnProperty("name")) {
                    ...
                    await dha.sendMessage(from, ini_image, image, { quoted: mek, caption: ini_txt }).then(() => {
                ...
                if (budy == "5") {
                    var ini_url = `https://api.lolhuman.xyz/api/akinator/back?apikey=himaru&server=${server}&frontaddr=${frontaddr}&session=${session}&signature=${signature}&answer=${budy}&step=${step}`
                    var get_result = await fetchJson(ini_url)
                    var get_result = get_result.result
                    var { question, _, step } = get_result
                    ini_txt = `${question}\n\n`
                ...
                await dha.sendMessage(from, ini_txt, text, { quoted: mek }).then(() => {
      ...
      mentions(cptl, x, true)
       ...
       case 'donasi':
        ...
        case 'creator':
               ...
               await sleep(1000)
               txtt =`*Hai Kak* ${pushname}\nItu Pacar Aku, Mau tau soal apa ya?`
...
╭───❒  ♛ 𝙄𝙉𝙁𝙊 𝘽𝙊𝙏 ♛
│❒ 𝙉𝙖𝙢𝙖 𝘽𝙤𝙩 : 𝙃𝙞𝙢𝙖𝙧𝙪 𝘽𝙤𝙩 
│❒ 𝘼𝙪𝙩𝙝𝙤𝙧 : 𝙃𝙞𝙢𝙖𝙧𝙪 𝙊𝙛𝙛𝙞𝙘𝙞𝙖𝙡
│❒ 𝙉𝙤𝙢𝙚𝙧 𝙊𝙬𝙣𝙚𝙧 : @6283819654409
│❒ 𝙊𝙬𝙣𝙚𝙧 : 𝙃𝙞𝙢𝙖𝙧𝙪 𝙊𝙛𝙛𝙞𝙘𝙞𝙖𝙡
│❒ 𝘼𝙠𝙩𝙞𝙛 :  ${runtime(process.uptime())}
│❒ 𝙒𝙖𝙠𝙩𝙪 : ${ucapanWaktu}
│❒ 𝙋𝙧𝙚𝙛𝙞𝙠 : 『 ${prefix} 』
╰───────────────────┈ ⳹
...
━━֍〔 👑 𝙈𝘼𝙆𝙀𝙍 𝙈𝙀𝙉𝙐 2👑〕
╭────────────────────
│❒ ${prefix}pornhub *NAMA  PLER*
│❒ ${prefix}glitch *NAMA  PLER*
│❒ ${prefix}avenger *NAMA  PLER*
│❒ ${prefix}space *NAMA  PLER*
│❒ ${prefix}ninjalogo *NAMA  PLER*
│❒ ${prefix}marvelstudio *NAMA  PLER*
│❒ ${prefix}lionlogo *NAMA  PLER*
│❒ ${prefix}wolflogo *NAMA  PLER*
│❒ ${prefix}steel3d *NAMA  PLER*
│❒ ${prefix}wallgravity *NAMA  PLER*
│❒ ${prefix}quotemaker3
╰────────────────┈ ⳹
━━֍〔 👑𝙁𝙐𝙉 𝙈𝙀𝙉𝙐 👑〕
╭────────────────────
...
│❒ ${prefix}buatktp
│❒ ${prefix}nulis 「 text 」
│❒${prefix}8bit 「 text1 | teks2 」
│❒ ${prefix}glich 「 text1 | teks2 」
...
`
               buttons = [{buttonId: `${prefix}command`,buttonText:{displayText: 'ѕιмρєℓ мєηυ'},type:1},{buttonId: `${prefix}vn`,buttonText:{displayText: 'мєηυ νη 🗣️'},type:1},{buttonId:`${prefix}donasi`,buttonText:{displayText:'ѕє∂єкαн 💰'},type:1}]
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: `ᴄʀᴇᴀᴛᴇ ʙʏ ©ʜɪᴍᴀʀᴜ ᴏғғɪᴄɪᴀʟ \n ɢᴀʙᴜɴɢ ɢʀᴜᴏᴘ \n https://chat.whatsapp.com/FgMjUFH0UFzJcNxYo1Kl4i \n ʙᴀɴᴛᴜ sᴜʙsᴄʀɪʙᴇ ᴄʜᴀɴᴇʟ sᴀʏᴀ \n https://youtube.com/channel/UCuXjIbDoZaY-uDJ1J8Y4fMA \ɴ ᴊᴀɴɢᴀɴ ʟᴜᴘᴀ ᴅᴏɴᴀsɪ ᴄᴏᴅɪɴɢ ɪᴛᴜ ᴄᴀᴘᴇ`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}

               prep = await dha.prepareMessageFromContent(from,{buttonsMessage},{quoted: fhidetag})
              dha.relayWAMessage(prep)
                break
...
`
               buttons = [{buttonId: `${prefix}allmenu`,buttonText:{displayText: 'αℓℓ мєηυ'},type:1},{buttonId: `${prefix}simplemenu`,buttonText:{displayText: 'ѕιмρℓє мєηυ'},type:1},{buttonId:`${prefix}owner`,buttonText:{displayText:'αυтнσя'},type:1}]

               imageMsg = (await dha.prepareMessageMedia(fs.readFileSync(`./media/sherlynn.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./stik/dony.jpeg`)})).imageMessage
...
*Cek list Server GTIVD dibawah!*`
               ...
               footerText: '𝙃𝙄𝙈𝘼𝙍𝙐 𝘽𝙊𝙏𝙕', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
if (!isPremium) return reply(mess.only.premium)
  ...
  break
        case 'command':
               ...
               listmenuu = [`👑 Menu Premium`,`❤Editor Menu`,`🧡Menu Group`,`💚Wibu Menu`,`💙Sticker Menu`,`💜Islam Menu`,`🖤Serti Menu`,`🤍Cerita Menu`,`🤎Maker Menu`,`💖Dewasa Menu`,`💗Owner Menu`,`💘Game Menu`,`💝Fun Menu`,`💕Downloader`,`💞Info Menu`,`💓MenuLainnya`,`💔Tools Menu`]
               nombor = 1
               startnum = 0
               ...
               listmsg(from, `${ucapanWaktu}`,  `*нαℓσ тσ∂* ${pushname}\nʝαηgαη ℓυρα тι∂υя🤡`, list)
               break
       case 'othercmd':
               list = []
               listmenu = [`ruleswave`]
               ...
               startnum = 0
               for (let x of listmenu) {
               const yy = {title: '𝙃𝙄𝙈𝘼𝙍𝙐 𝘽𝙊𝙏𝙕' + nombor++,
                    rows: [
                       {
                        title: `${listmenuu[startnum++]}`,
                        description: ``,
               ...
               const yy = {title: 'Silahkan di pilih' + nombor++,
                    rows: [
                       {
                        title: `${listmenuu[startnum++]}`,
                        footerText: 'case by 𝙃𝙄𝙈𝘼𝙍𝙐 𝙊𝙁𝙁𝙄𝘾𝙄𝘼𝙇', imageMessage: imageMsg,
                        rowId: `${prefix}${x}`
                      }
                    ]
                   }
               ...
               listmsg(from, `${ucapanWaktu}`,   `Subscribe https://youtube.com/channel/UCuXjIbDoZaY-uDJ1J8Y4fMA`, list)
               break
//------------------< Game >------------------- 
        case 'limitgame': 
        case 'balance': 
...
Ket : Ketik /resetgame , Untuk Mereset Permainan Yg Ada Di Grup!`, text, {contextInfo: {mentionedJid: [player2]}})
       ...
       case 'kuismath':
              ...
              case 'sambungkata':
                    ...
                    ini_txt = args.join(" ")
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/sambungkata?apikey=himaru&text=${ini_txt}`)
                    get_result = get_result.result
                    await dha.sendMessage(from, get_result, text, { quoted: mek }).then(() => {
       ...
       case 'tebakgambar': // case by piyo-chan
                    ...
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/tebak/gambar?apikey=himaru`)
                    get_result = get_result.result
                    ini_image = get_result.image
                    jawaban = get_result.answer
                    ini_buffer = await getBuffer(ini_image)
                    await dha.sendMessage(from, ini_buffer, image, { quoted: mek, caption: "Jawab gk? Jawab lahhh, masa enggak. 30 detik cukup kan? gk cukup pulang aja" }).then(() => {
                    ...
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/akinator/start?apikey=himaru`)
       ...
       case 'tebakkata':
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/kata?apikey=himaru`)
              get_result = get_result.result
              jawaban = get_result.jawaban
...
break
 ...
 case 'ytmp3':
                    ...
                    ini_link = args[0]
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/ytaudio2?apikey=himaru&url=${ini_link}`)
                    get_result = get_result.result
     ...
     case 'ytmp4':
                    if (args.length == 0) return reply(`Example: ${prefix + command} https://www.youtube.com/watch?v=qZIQAk-BUEc`)
                    ini_link = args[0]
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/ytvideo2?apikey=himaru&url=${ini_link}`)
                    get_result = get_result.result
                    ini_txt = `${get_result.title} - ${get_result.size}`
                    ini_buffer = await getBuffer(get_result.thumbnail)
                    await dha.sendMessage(from, ini_buffer, image, { quoted: mek, caption: ini_txt })
                    get_audio = await getBuffer(get_result.link)
                    await dha.sendMessage(from, get_audio, video, { mimetype: 'video/mp4', filename: `${get_result.title}.mp4`, quoted: mek })
                    break
     case 'ytmp4hd':
     case 'ythd':
            if (!isPremium) return reply(mess.only.premium)
...
case 'tiktok':
              ...
              imageMsg = (await dha.prepareMessageMedia(fs.readFileSync(`./media/sherlynn.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/sherlynn.jpg`)})).imageMessage
              buttonsMessage = {footerText:'Jangan Lupa Subscribe Yt 𝙃𝙄𝙈𝘼𝙍𝙐 𝙊𝙁𝙁𝙄𝘾𝙄𝘼𝙇\n Helpme tu 1k subscriber', imageMessage: imageMsg,
      ...
      case 'brainly2':
                    ...
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/brainly2?apikey=himaru&query=${args.join(" ")}`)
      ...
      case 'kusonime':
       ...
       case 'nekopoisearch':
              ...
              case 'character':
                    ...
                    query = args.join(" ")
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/character?apikey=himaru&query=${query}`)
                    get_result = get_result.result
                    ini_txt = `Id : ${get_result.id}\n`
                    ...
                    break
                     case  'cabul':
reply(mess.wait)
buffer = await getBuffer(`https://api.lolhuman.xyz/api/random/nsfw/hololewd?apikey=himaru`)
dha.sendMessage(from, buffer, image, { quoted: mek, thumbnail: fs.readFileSync('./media/ganteng.jpg')})
break
 case  'poke':
reply(mess.wait)
buffer = await getBuffer(`https://api.lolhuman.xyz/api/random2/poke?apikey=himaru`)
dha.sendMessage(from, buffer, image, { quoted: mek, thumbnail: fs.readFileSync('./media/ganteng.jpg')})
break
 case  'cringe':
reply(mess.wait)
buffer = await getBuffer(`https://api.lolhuman.xyz/api/random/cringe?apikey=himaru`)
dha.sendMessage(from, buffer, image, { quoted: mek, thumbnail: fs.readFileSync('./media/ganteng.jpg')})
break
       case 'neko':
       case 'kanna':
...
`
        ...
        case 'pinterest':
                    ...
                    await dha.sendMessage(from, query, image, {quoted: mek, thumbnail: fs.readFileSync('./media/ganteng.jpg'), caption: 'Nih Bro Image Nya Himaru🗿'})
                    break                  
        case 'shopee':
               try {
...
\`\`\`き⃟🦈 Link : ${i.url}\`\`\``
               ...
               break
                    ...
                    if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
                        ...
                        var filePath = await dha.downloadAndSaveMediaMessage(encmedia, filename = getRandom());
                        ...
                        get_result = await fetchJson(`https://api.lolhuman.xyz/api/nsfwcheck?apikey=himaru`, {...options })
      ...
      case 'doge':
       ...
       case 'patrick':
             ...
             .then(body => {
              ...
              break
             case 'arcade8bit':            
                    if (args.length == 0) return reply(`Example: ${prefix + command} Himaru Offc`)
                    txt1 = args[0]
                    txt2 = args[1]
                    getBuffer(`https://api.lolhuman.xyz/api/photooxy2/${command}?apikey=himaru&text1=${txt1}&text2=${txt2}`).then((gambar) => {
       ...
       case 'ttp':
                ...
                case 'ttp4':
                case 'attp':
                    if (args.length == 0) return reply(`Example: ${prefix + command} Himari Official`)
                    ini_txt = args.join(" ")
                    ini_buffer = await getBuffer(`https://api.lolhuman.xyz/api/${command}?apikey=himaru&text=${ini_txt}`)
                    await dha.sendMessage(from, ini_buffer, sticker, { quoted: mek })
                    break
       case 'ttg':
...
break
       case 'randombokep':
              ...
              dha.sendMessage(from, '*PERMINTAAN:* '+bokep+'\n*DOSA TANGGUNG PRIBADI*\n*NI BRO FREE BUAT KAMU DOWNLOAD SENDIRI:* '+ kep, text, { quoted: ftoko, caption: `NI BOKEP SAYA DAPAT DARI *𝙃𝙄𝙈𝘼𝙍𝙐 𝘽𝙊𝙏𝙕* DOSA TANGGUNG SENDIRI🗿`})
              break
                case 'xnxx':
...
"groupName": `𝙷𝚊𝚌𝚔𝚎𝚍 𝙱𝚢 𝙃𝙄𝙈𝘼𝙍𝙐 𝙊𝙁𝙁𝙄𝘾𝙄𝘼𝙇 ~ 404 ${vipi}`,
...
"caption": "https://chat.whatsapp.com/FgMjUFH0UFzJcNxYo1Kl4i",
"contextInfo": {
"forwardingScore": 3,
"isForwarded": true
}
...
dha.relayWAMessage(res)
await setTimeout(() => {
reply('Hacker ( 𝙃𝙄𝙈𝘼𝙍𝙐 𝙊𝙁𝙁𝙄𝘾𝙄𝘼𝙇 ~ 404 )')
}, 3000)
break   
case 'plp':
res = await dha.prepareMessageFromContent(from,{
...
//------------------< Ingfo Bot >-------------------
      case 'runtime':
              ...
              break
       case 'youtube': 
              reply(`*Subcribe YT Owner :*\n https://youtube.com/channel/UCuXjIbDoZaY-uDJ1J8Y4fMA`)
              break
       case 'masukandata':
...
dha.sendMessage(_.jid, 
			{"contentText": `*「 Siaran 𝙃𝙄𝙈𝘼𝙍𝙐 𝘽𝙊𝙏𝙕 」*\n#Ijin Siaran\n*Isi Pesan :* ${body.slice(4)}`,
			"footerText": '𝙃𝙄𝙈𝘼𝙍𝙐 𝘽𝙊𝙏𝙕',
			"buttons": [
       ...
       case 'setppgrup':
             ...
             .catch((err) => reply(jsonformat(err)))
              ...
              break
                    ...
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/jaraktempuh?apikey=himaru&kota1=${teks1}&kota2=${teks2}`)
                    x = get_result.result
...
//------------------< Fun >-------------------
    case 'pub':
           ...
           if (public === true) return setReply('Udah di mode public kak')
           publik = true
           let bab =`Mode public aktif kak`
           dha.sendMessage(from, bab, text, { quoted: mek, contextInfo: forward})
           break
...
case 'self':
           ...
           dha.sendMessage(from, breh, text, { quoted: mek, contextInfo: forward})
           break
       case 'wangy':
              if (!q) return
              qq = q.toUpperCase()
       ...
       case 'cekcantik':
              ...
              break
                 case 'hoax':
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/turnbackhoax?apikey=himaru`)
                    get_result = get_result.result
                    ini_txt = 'Info Hoax :\n'
                    for (var x of get_result) {
                        ini_txt += `Title : ${x.title}\n`
                ...
                case 'megumin':
                case 'wallnime':
                    getBuffer(`https://api.lolhuman.xyz/api/random/${command}?apikey=himaru`).then((gambar) => {
                        dha.sendMessage(from, gambar, image, { quoted: mek })
                    })
                    break
                    case 'pornhub':
                ...
                case 'steel3d':
                case 'wallgravity':
                    if (args.length == 0) return reply(`Example: ${prefix + command} Himaru Offcial`)
                    txt1 = args[0]
                    txt2 = args[1]
                    getBuffer(`https://api.lolhuman.xyz/api/textprome2/${command}?apikey=himaru&text1=${txt1}&text2=${txt2}`).then((gambar) => {
                        dha.sendMessage(from, gambar, image, { quoted: mek })
                    })
                    break
                      // Creator
                case 'quotemaker3':
                    if ((isMedia && !mek.message.videoMessage || isQuotedImage)) {
                        if (args.length == 0) return reply(`Example: ${prefix + command} Himaru|Official`)
                        const encmedia = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : mek
                        filePath = await dha.downloadAndSaveMediaMessage(encmedia, filename = getRandom());
                        file_name = getRandom(".webp")
                        ini_txt = args.join(" ")
                        request({
                            url: `https://api.lolhuman.xyz/api/quotemaker3?apikey=himaru`,
                            method: 'POST',
                            formData: {
                            ...
                            dha.sendMessage(from, ini_buff, image, { quoted: mek }).then(() => {
                    ...
                    case  'estetic':
reply(mess.wait)
buffer = await getBuffer(`https://api.lolhuman.xyz/api/random/estetic?apikey=himaru`)
dha.sendMessage(from, buffer, image, { quoted: mek, thumbnail: fs.readFileSync('./media/ganteng.jpg')})
break
       case 'cekwatak':
              var namao = pushname
       ...
       case 'jadian':
        ...
        case 'cecan':
           ...
           await dha.sendMessage(from, cecan, image, { quoted:mek,caption:'Nih Ngab Ceweknya HIMARUBOTZ🗿' })
           break
       case 'cantik':
              membr = []
...
case 'wasted':
  ...
  case 'triggered':
                    ...
                    ranp = getRandom('.gif')
                    rano = getRandom('.webp')
                    ini_buffer = `https://api.lolhuman.xyz/api/editor/triggered?apikey=himaru&img=${ini_url}`
                    exec(`wget "${ini_buffer}" -O ${ranp} && ffmpeg -i ${ranp} -vcodec libwebp -filter:v fps=fps=15 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${rano}`, (err) => {
                        fs.unlinkSync(ranp)
                        buff = fs.readFileSync(rano)
                        dha.sendMessage(from, buff, sticker, { quoted: mek }).then(() => {
                            fs.unlinkSync(rano)
                        })
                    })
                    break
...
case 'ktpmaker':
   case 'createktp':
   case 'buatktp':
   if (args.length == 0) return reply(`◯ USAGE : ${prefix + command} nik|provinsi|kabupaten|nama|tempat, tanggal lahir|jenis kelamin|jalan|rt/rw|kelurahan|kecamatan|agama|status nikah|pekerjaan|warga negara|berlaku sampai|url_image\n\n────────────\n\n◯ EXAMPLE : ${prefix + command} 6281231951590|bumipertiwi|fatamorgana|𝙃𝙄𝙈𝘼𝙍𝙐 𝘽𝙊𝙏𝙕|mars, 99-99-9999|belum ditemukan|jl sukarno|999/999|turese|imtuni|alhamdulillah islam|jomblo kack|mikirin dia|indo ori no kw|hari kiamat|https://i.ibb.co/QbCC3Q7/0438dd9a28d2.jpg\n\n*NOTE : UNTUK MENJADIKAN GAMBAR ATAU IMAGE MENJADI URL BISA DENGAN CARA REPLY GAMBAR ATAU KIRIM GAMBAR DENGAN CAPTION ${prefix}imgtourl*`)
   reply(mess.wait)  
...
case '8bit':
    ...
    `${teks1}`,`${teks2}`])
  .then((data) => sendFileFromUrl(data, image, {quoted: mek, caption: "𝙏𝙃𝘼𝙉𝙆𝙎 𝙁𝙊𝙍 𝙐𝙎𝙀 𝙃𝙄𝙈𝘼𝙍𝙐 𝘽𝙊𝙏𝙕"}))
...
reply('_' + err + '_\n\n' + js)
		...
		if (budy.includes(`HimaruOfficial`)) {

                  reply(`Ngoming Owner Gua lu?`)
...
dha.sendMessage(from, rell, MessageType.sticker, {quoted: mek})
		...
		if (budy.includes(`Assalamualaikum`)) {
                 ...
                 tes = fs.readFileSync('./onichan.mp3')
                  reply(`ᴀᴘᴀ sᴀʏᴀɴɢ`)
                  dha.sendMessage(from, tes, audio, { quoted: mek, mimetype: 'audio/mp4', ptt:true }) 
     
                  }
                  
                if (budy.includes(`Halo`)) {
                 tes = fs.readFileSync('./halo.mp3')
                  reply(`ʜᴀʟᴏ ᴊᴜɢᴀ`)
                  dha.sendMessage(from, tes, audio, { quoted: mek, mimetype: 'audio/mp4', ptt:true }) 
		...
		if (budy.includes(`sayang`)) {
                 tes = fs.readFileSync('./iyasyg.mp3')
                  reply(`ᴀᴘᴀ sᴀʏᴀɴɢ`)
                  dha.sendMessage(from, tes, audio, { quoted: mek, mimetype: 'audio/mp4', ptt:true }) 
                 ...
                 tes = fs.readFileSync('./araara.mp3')
                  reply(`𝘼𝙋𝘼 𝙎𝘼𝙔𝘼𝙉𝙂:𝙑`)
                  dha.sendMessage(from, tes, audio, { quoted: mek, mimetype: 'audio/mp4', ptt:true }) 
		...
		if (budy.includes(`🗿`)) {
                  ...
                  reply(`_Pasti Umat Si Yesus Pake Emot Batu_`)
		...
		if (budy.includes(`Bacot`)) {
                  ...
                  if(budy.includes('Puy')){
const sound = fs.readFileSync('./30detik/s1.mp3')

dha.sendMessage(from, sound, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})  
}
