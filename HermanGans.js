...
const starts = async (dha = new WAConnection()) => {
	...
	console.log(color(figlet.textSync('HimaruOffc', {
		font: 'Standard',
	...
	console.log(color('\n\n[ Hati-Hati Himaru Official Mengintai !! ]', 'red'))
	dha.browserDescription = ["Lord Himaru Mengintai", "Chrome", "3.0.0"];
	...
	dha.on('connecting', () => {
		console.log(color('[ 𝙃𝙄𝙈𝘼𝙍𝙐 𝙊𝙁𝙁𝙄𝘾𝙄𝘼𝙇 ]', 'yellow'), color('PROSES NYAMBUNG...'));
	})
const spinner = { 
  "interval": 120,
  "frames": [
	...
	//connect
	dha.on('open', () => {
		console.log(color('[ 𝙃𝙄𝙈𝘼𝙍𝙐 𝘽𝙊𝙏𝙕 ]', 'yellow'), color('BOT SUDAH AKTIF'));
	})
